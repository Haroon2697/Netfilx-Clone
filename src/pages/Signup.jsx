        ...
        <div className='max-w-[320px] mx-auto py-16'>
          ...
          <form className='w-full flex flex-col py-4 '>
              ...
              <input type='password'
               ...
               className='bg-gray-800 my-2 p-3 border border-gray-800 rounded-sm' />
            <button type='Sign up' className=' bg-red-600 text-white py-3 my-6 rounded-sm hover:bg-red-700 transition duration-300'>Sign Up</button>
         <div className='flex justify-between items-center'>
          ...
          <div className='flex justify-between items-center  mt-8'>
            <p className='py-4'>
            <span className='text-gray-200'>Already have account?
            </span>{' '}
            <Link to='/login'>
